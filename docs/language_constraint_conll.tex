...
\caption{The distribution of five frequent POS tags
  ...
  across {\color{blue}{\emph{original}}} endings (story cloze training set), and
  {\color{forestgreen}{\emph{right}}} and {\color{red}{\emph{wrong}}} endings (from the story cloze task).}
