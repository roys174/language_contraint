...
\com{        \addplot[style={bblue,fill=bblue,mark=none}]
        ...
        \addplot[pattern=dots,style={rred,fill=rred,mark=none}]
...
\caption{The distribution of five frequent POS tags
  ...
  {\color{forestgreen}{\emph{right}}} (diagonal lines) and {\color{red}{\emph{wrong}}} (solid lines) endings, both from the story cloze task.}
...
$\eta=0.001$, we train to minimize cross-entropy. % minibatches of $50$ stories.
