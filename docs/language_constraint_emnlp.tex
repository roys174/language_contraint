...
{\bf Story Prefix} & {\bf Ending} \\ \hline
\multirow{4}{*}{\parbox{4.75cm}{%Joe went to college for art. He graduated with a degree in painting. He couldn't find a job. He then responded to an ad in the paper.
\vspace{.1cm}Betsy comes home late one night and wants to eat something simple.	She notices that she has spaghetti and sauce in the house.	She quickly cooks and eats a pot of spaghetti.	After eating, she falls asleep on the couch.}} & \vspace{-0.3cm}	{\color{blue}{{\it \tiny $<$waiting for examples from  Nasrin$>$}}} \\ \cline{2-2}
& 	{\color{forestgreen}{\vspace{-0.1cm}She was full and happy.     %Then he got hired.
}} \\ \cline{2-2}
& {\color{red}{%Joe hated pizza.
\vspace{-0.1cm}Betsy likes{\color{white}{0}}{\color{white}{0}}{\color{white}{0}}{\color{white}{0}} cheeseburgers.}} \\\hline %\cline{2-2}
%&  \\ \hline
\end{tabularx}
\caption{\label{ROC-example}
...
To apply it to the classification problem, we select
