...
story cloze challenge \nascomment{cite the challenge?  a reader may
  not realize that there is a shared task on this}. 
...
\roy{Tricky. Which number should we report here? leave empty?}
...
model. \nascomment{added this to replace the hedging that was here before}}
...
\roy{Commented out the lessons about the importance of running
  baselines.} 
