...
In addition, %our style-based classifier's performance on the story cloze challenge is comparable \nascomment{why isn't this stronger?} to the state of the art.
...
%\yc{I think ACL formatting guideline requires that we make color coding accessible to people who are color blinds. Also in general, it's better not to rely only on color differences in encoding different types of annotations in text.}
...
%\nascomment{should this be updated given the shared task, and Gimpel's results?} 
